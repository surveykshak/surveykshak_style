...
<qgis version="2.8.3-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="#ef1616"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="TopoSymbol/BUOY.svg"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="#ff0000"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="Angle"/>
  ...
  <displayfield>Angle</displayfield>
  <label>0</label>
  <labelattributes>
