...
<qgis version="2.4.0-Chugiak" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SvgMarker" locked="0">
          ...
          <prop k="name" v="TopoSymbol/RDSTK.svg"/>
          <prop k="offset" v="0,0"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="ROAD_CLASS"/>
    <edittype labelontop="0" editable="1" name="ADDL_INFO"/>
    <edittype labelontop="0" editable="1" name="STONE_ID"/>
    <edittype labelontop="0" editable="1" name="DISTNCE_KM"/>
  </edittypes>
  <editform></editform>
