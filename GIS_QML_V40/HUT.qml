...
<qgis labelsEnabled="0" simplifyAlgorithm="0" version="3.0.0-Nihcas C" maxScale="0" simplifyLocal="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="25000" hasScaleBasedVisibilityFlag="1" readOnly="0" simplifyDrawingHints="0">
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory lineSizeType="MM" diagramOrientation="Up" minScaleDenominator="0" sizeScale="3x:0,0,0,0,0,0" height="15" scaleBasedVisibility="1" backgroundAlpha="255" penAlpha="255" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" barWidth="5" scaleDependency="Area" labelPlacementMethod="XHeight" rotationOffset="270" sizeType="MM" backgroundColor="#ffffff" penColor="#000000" width="15" opacity="1" enabled="0" maxScaleDenominator="25000" minimumSize="0">
      <fontProperties style="" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0"/>
    </DiagramCategory>
  </SingleCategoryDiagramRenderer>
  <DiagramLayerSettings linePlacementFlags="18" dist="0" obstacle="0" showAll="1" placement="0" priority="0" zIndex="0">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    <alias index="0" field="VIL_PT_UID" name=""/>
    <alias index="1" field="TYPE" name=""/>
    <alias index="2" field="GMROTATION" name=""/>
    <alias index="3" field="SORCE_INFO" name=""/>
    <alias index="4" field="ADDL_INFO" name=""/>
    <alias index="5" field="PHOTOGRAPH" name=""/>
    <alias index="6" field="UNIQUE_ID" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default expression="" field="VIL_PT_UID" applyOnUpdate="0"/>
  ...
  <constraints>
    <constraint exp_strength="0" field="VIL_PT_UID" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="TYPE" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="GMROTATION" notnull_strength="0" unique_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    <constraint field="VIL_PT_UID" desc="" exp=""/>
    <constraint field="TYPE" desc="" exp=""/>
    <constraint field="GMROTATION" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" name="GMROTATION" type="field" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="VIL_PT_UID"/>
  </labelOnTop>
  <widgets/>
  <conditionalstyles>
    <rowstyles/>
  ...
  <expressionfields/>
  <previewExpression>VIL_PT_UID</previewExpression>
  <mapTip>ID1</mapTip>
