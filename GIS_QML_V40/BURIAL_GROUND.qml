...
<qgis labelsEnabled="0" simplifyAlgorithm="0" version="3.0.0-Nihcas C" maxScale="1" simplifyLocal="1" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="25000" hasScaleBasedVisibilityFlag="1" readOnly="0" simplifyDrawingHints="1">
  <renderer-v2 type="singleSymbol" forceraster="0" enableorderby="0" symbollevels="0">
    <symbols>
      <symbol name="0" type="fill" clip_to_extent="1" alpha="1">
        <layer pass="0" class="MarkerLine" enabled="1" locked="0">
          <prop v="0.55" k="interval"/>
  ...
  <aliases>
    ...
    <alias index="1" field="LOC_NAME" name=""/>
    <alias index="2" field="DIMENSION" name=""/>
    <alias index="3" field="SORCE_INFO" name=""/>
    <alias index="4" field="AREA_SQ_KM" name=""/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" field="LOC_NAME" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="DIMENSION" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="SORCE_INFO" notnull_strength="0" unique_strength="0" constraints="0"/>
    <constraint exp_strength="0" field="AREA_SQ_KM" notnull_strength="0" unique_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="AREA_SQ_KM" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="-1" name="DIMENSION" type="field" hidden="0"/>
      <column width="-1" name="SORCE_INFO" type="field" hidden="0"/>
      <column width="-1" name="AREA_SQ_KM" type="field" hidden="0"/>
