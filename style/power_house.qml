    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        ...
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="TopoSymbol/POWER_HOUSE.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="stn_name" editable="1"/>
    <field name="stn_type" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="stn_name"/>
    <field labelOnTop="0" name="stn_type"/>
  ...
  <widgets/>
  <previewExpression>"addl_info"</previewExpression>
  <mapTip>[% "addl_info" %]</mapTip>
