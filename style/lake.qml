...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{7b7b88c0-441a-44d2-94a3-6f522c462b0a}">
      <rule label="Lake 1:8000000 to 1:500000" key="{c01133b4-0657-4ccc-b048-c582fa2adffd}" filter=" &quot;rank&quot;  =  1 " scalemaxdenom="8000000" symbol="0" scalemindenom="1"/>
      <rule label="Lakes 1:2300000 to 1:500000" key="{91c1862d-2959-4942-9326-c6fbcccb9c67}" filter=" &quot;rank&quot;  = 2" scalemaxdenom="2300000" symbol="1" scalemindenom="1"/>
      <rule label="Lakes 1:500000 to 1:1" key="{136e366c-24e2-4131-9a56-0152e460d34c}" filter=" &quot;rank&quot;  = 2" scalemaxdenom="500000" symbol="2" scalemindenom="1"/>
    </rules>
    <symbols>
      <symbol type="fill" clip_to_extent="1" alpha="1" name="0">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="0,255,255,147" k="color"/>
        ...
        <layer class="CentroidFill" pass="0" locked="0" enabled="0">
      ...
      <symbol type="fill" clip_to_extent="1" alpha="1" name="2">
        ...
        <layer class="CentroidFill" pass="0" locked="0" enabled="0">
          ...
          <symbol type="marker" clip_to_extent="1" alpha="1" name="@2@1">
            <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
              <prop v="0" k="angle"/>
              <prop v="255,0,0,255" k="color"/>
              <prop v="1" k="horizontal_anchor_point"/>
  ...
  <aliases>
    ...
    <alias index="3" field="aas_id" name=""/>
    <alias index="4" field="name" name=""/>
    <alias index="5" field="area_sq_m" name=""/>
    <alias index="6" field="volume_cum" name=""/>
    <alias index="7" field="potability" name=""/>
    <alias index="8" field="source" name=""/>
    <alias index="9" field="lined" name=""/>
    <alias index="10" field="sorce_info" name=""/>
    <alias index="11" field="bank_ht" name=""/>
    <alias index="12" field="depth_summ" name=""/>
    <alias index="13" field="depth_rain" name=""/>
    <alias index="14" field="depth_wint" name=""/>
    ...
    <alias index="23" field="rank" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="volume_cum" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="volume_cum" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="potability" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="source" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="volume_cum"/>
