...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="fill" clip_to_extent="1" alpha="1" name="0">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          ...
          <prop v="106,121,106,255" k="outline_color"/>
  ...
  <aliases>
    ...
    <alias index="3" field="area_name" name=""/>
    <alias index="4" field="location" name=""/>
    <alias index="5" field="affectd_rd" name=""/>
    <alias index="6" field="frequency" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="area_name" applyOnUpdate="0"/>
    <default expression="" field="location" applyOnUpdate="0"/>
    <default expression="" field="affectd_rd" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="area_name" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="location" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="affectd_rd" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="frequency" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="area_name"/>
    <constraint exp="" desc="" field="location"/>
    <constraint exp="" desc="" field="affectd_rd"/>
    <constraint exp="" desc="" field="frequency"/>
