...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="3" field="place_from" name=""/>
    <alias index="4" field="place_to" name=""/>
    <alias index="5" field="type" name=""/>
    <alias index="6" field="exch_id" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="place_from" applyOnUpdate="0"/>
    <default expression="" field="place_to" applyOnUpdate="0"/>
    <default expression="" field="type" applyOnUpdate="0"/>
    <default expression="" field="exch_id" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="place_from" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="place_to" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="exch_id" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="place_from"/>
    <constraint exp="" desc="" field="place_to"/>
    <constraint exp="" desc="" field="type"/>
    <constraint exp="" desc="" field="exch_id"/>
