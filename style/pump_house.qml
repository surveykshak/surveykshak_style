...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="symbol/watertap-svgrepo-com.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="2" field="motors_nos" name=""/>
    <alias index="3" field="addl_info" name=""/>
    <alias index="4" field="image_sour" name=""/>
    <alias index="5" field="scale" name=""/>
    <alias index="6" field="image_year" name=""/>
    <alias index="7" field="a_br" name=""/>
    <alias index="8" field="fclass" name=""/>
    <alias index="9" field="unique_id" name=""/>
    <alias index="10" field="capacity" name=""/>
    <alias index="11" field="intake_dia" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="motors_nos" applyOnUpdate="0"/>
    ...
    <default expression="" field="intake_dia" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="motors_nos" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="intake_dia" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="motors_nos"/>
    ...
    <constraint exp="" desc="" field="intake_dia"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="motors_nos" hidden="0"/>
      ...
      <column type="field" width="-1" name="intake_dia" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="intake_dia" editable="1"/>
    <field name="motors_nos" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="intake_dia"/>
    <field labelOnTop="0" name="motors_nos"/>
