...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="6" field="attr_fill" name=""/>
    <alias index="7" field="updated_on" name=""/>
    <alias index="8" field="image_source" name=""/>
    <alias index="9" field="scale" name=""/>
    <alias index="10" field="image_year" name=""/>
    <alias index="11" field="fclass" name=""/>
    <alias index="12" field="a_br" name=""/>
    <alias index="13" field="location" name=""/>
    <alias index="14" field="water_avlb" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="water_avlb" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="water_avlb" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="water_avlb"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="water_avlb" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="water_avlb" editable="1"/>
  </editable>
  <labelOnTop>
    ...
    <field labelOnTop="0" name="water_avlb"/>
  </labelOnTop>
  <widgets/>
