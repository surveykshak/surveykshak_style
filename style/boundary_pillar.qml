...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="3" field="pillar_no" name=""/>
    <alias index="4" field="own_contrl" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="pillar_no" applyOnUpdate="0"/>
    <default expression="" field="own_contrl" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="pillar_no" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="own_contrl" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="pillar_no"/>
    <constraint exp="" desc="" field="own_contrl"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="pillar_no" hidden="0"/>
      <column type="field" width="-1" name="own_contrl" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="own_contrl" editable="1"/>
    <field name="photograph" editable="1"/>
    <field name="pillar_no" editable="1"/>
