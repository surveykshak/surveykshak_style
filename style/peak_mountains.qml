...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="symbol/mountain-svgrepo-com.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <labeling type="rule-based">
    <rules key="{41836a2a-6732-4895-b00d-a6e2225a0dbc}">
      <rule key="{4e303a0f-c86f-4c3c-9481-b9b6e4746cb4}" filter=" &quot;name&quot; not like '%Finger%' AND &quot;name&quot; not like '%FINGER%'" description="Display name except Fingure">
        <settings>
          <text-style fontSize="10" useSubstitutions="0" multilineHeight="1" fontLetterSpacing="0" fontStrikeout="0" fontFamily="MS Shell Dlg 2" namedStyle="Regular" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontWordSpacing="0" fontItalic="0" isExpression="1" fontSizeUnit="Point" textOpacity="1" previewBkgrdColor="#000000" blendMode="0" fontCapitals="0" textColor="0,0,0,255" fontWeight="50" fieldName="&quot;name&quot; || ':' || &quot;elevation&quot;">
            <text-buffer bufferBlendMode="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferDraw="1" bufferColor="239,249,198,255" bufferNoFill="1" bufferOpacity="1"/>
          ...
          <placement placementFlags="10" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="0" xOffset="0" repeatDistance="0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MM" dist="2" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" centroidInside="0" preserveRotation="1" priority="8" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationAngle="0" offsetType="0" quadOffset="4"/>
          <rendering upsidedownLabels="0" labelPerPart="0" minFeatureSize="0" maxNumLabels="2000" scaleMin="0" mergeLines="0" fontMaxPixelSize="10000" zIndex="0" fontMinPixelSize="3" obstacle="1" scaleMax="10000" scaleVisibility="0" displayAll="1" obstacleFactor="1" obstacleType="1" fontLimitPixelSize="0" drawLabels="1" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option name="properties"/>
      ...
      <rule active="0" key="{4e666671-34de-40a5-8dd1-c17df1f4f32f}" filter=" &quot;name&quot; like '%Finger%'">
        <settings>
          <text-style fontSize="10" useSubstitutions="0" multilineHeight="1" fontLetterSpacing="0" fontStrikeout="0" fontFamily="MS Shell Dlg 2" namedStyle="Regular" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontWordSpacing="0" fontItalic="0" isExpression="1" fontSizeUnit="Point" textOpacity="1" previewBkgrdColor="#000000" blendMode="0" fontCapitals="0" textColor="0,0,0,255" fontWeight="50" fieldName="&quot;name&quot; || ':' || &quot;elevation&quot;">
            <text-buffer bufferBlendMode="0" bufferSize="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferJoinStyle="128" bufferSizeUnits="MM" bufferDraw="1" bufferColor="239,249,198,255" bufferNoFill="1" bufferOpacity="1"/>
            <background shapeSizeType="0" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeJoinStyle="64" shapeSizeX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeOffsetX="0" shapeRadiiX="0" shapeBlendMode="0" shapeSVGFile="" shapeSizeUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeOffsetY="0" shapeOpacity="1" shapeOffsetUnit="MM" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeType="0" shapeRadiiUnit="MM" shapeBorderWidth="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeDraw="0" shapeFillColor="255,255,255,255"/>
  ...
  <aliases>
    ...
    <alias index="6" field="fclass" name=""/>
    <alias index="7" field="elevation" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="214" name="name" hidden="0"/>
