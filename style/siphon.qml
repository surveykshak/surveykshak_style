...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="C:/Program Files/SURVEYKSHAK 3.1/apps/qgis/svg/TopoSymbol/SIPHON.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="4" field="along_uid" name=""/>
    <alias index="5" field="along_type" name=""/>
    <alias index="6" field="length" name=""/>
    <alias index="7" field="no_spans" name=""/>
    <alias index="8" field="sorce_info" name=""/>
    <alias index="9" field="canal_per" name=""/>
    <alias index="10" field="upon_uid" name=""/>
    <alias index="11" field="disch_rate" name=""/>
    <alias index="12" field="addl_info" name=""/>
    <alias index="13" field="photograph" name=""/>
    <alias index="14" field="rotation" name=""/>
    ...
    <alias index="19" field="a_br" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="no_spans" applyOnUpdate="0"/>
    <default expression="" field="sorce_info" applyOnUpdate="0"/>
    <default expression="" field="canal_per" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="along_uid" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="along_type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="length" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="no_spans" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="sorce_info" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="canal_per" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="along_uid"/>
    <constraint exp="" desc="" field="along_type"/>
    <constraint exp="" desc="" field="length"/>
    <constraint exp="" desc="" field="no_spans"/>
    <constraint exp="" desc="" field="sorce_info"/>
    <constraint exp="" desc="" field="canal_per"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="along_uid" hidden="0"/>
      <column type="field" width="-1" name="along_type" hidden="0"/>
      <column type="field" width="-1" name="no_spans" hidden="0"/>
      <column type="field" width="-1" name="sorce_info" hidden="0"/>
      <column type="field" width="-1" name="canal_per" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="along_type" editable="1"/>
    <field name="along_uid" editable="1"/>
    <field name="attr_fill" editable="1"/>
    <field name="canal_per" editable="1"/>
    ...
    <field name="no_spans" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="along_type"/>
    <field labelOnTop="0" name="along_uid"/>
    <field labelOnTop="0" name="attr_fill"/>
    <field labelOnTop="0" name="canal_per"/>
    ...
    <field labelOnTop="0" name="no_spans"/>
