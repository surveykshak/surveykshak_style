...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{d2ba5323-c833-40b8-9f62-55f1fbfa6c4f}">
      <rule label="Post" key="{3681aa11-0d5d-4768-8568-d1b59530997d}" filter="if ( &quot;name&quot; is not null,name,'')" scalemaxdenom="108544" symbol="0" scalemindenom="1000"/>
      <rule key="{0ae84d07-eb87-47f6-9d80-f0f14e2bf305}" symbol="1"/>
      <rule label="Post" key="{e609b4d8-5e39-442e-8131-ecba963b66db}" filter="if ( &quot;name&quot; is null,'','')" scalemaxdenom="108544" symbol="2" scalemindenom="1000"/>
    </rules>
    <symbols>
  ...
  <labeling type="rule-based">
    <rules key="{f339f58c-c483-4c46-8a08-8d08c8a65e90}">
      <rule key="{a1aaaf88-7299-49e6-964b-61d90f1eaba5}" filter=" &quot;imp&quot;  LIKE  '%Fingers'">
        <settings>
          <text-style fontSize="15" useSubstitutions="0" multilineHeight="1" fontLetterSpacing="0" fontStrikeout="0" fontFamily="Arial" namedStyle="Bold Italic" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontUnderline="0" fontWordSpacing="0" fontItalic="1" isExpression="1" fontSizeUnit="Point" textOpacity="1" previewBkgrdColor="#000000" blendMode="0" fontCapitals="0" textColor="0,0,0,255" fontWeight="75" fieldName=" regexp_substr(name, '(\\d+)')">
          ...
          <text-format leftDirectionSymbol="&lt;" rightDirectionSymbol=">" addDirectionSymbol="0" autoWrapLength="0" plussign="1" wrapChar="" multilineAlign="1" reverseDirectionSymbol="0" decimals="0" formatNumbers="0" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1"/>
          <placement placementFlags="9" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="1" xOffset="0" repeatDistance="0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MapUnit" dist="0" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" centroidInside="0" preserveRotation="1" priority="10" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationAngle="0" offsetType="0" quadOffset="2"/>
          <rendering upsidedownLabels="0" labelPerPart="0" minFeatureSize="1" maxNumLabels="2000" scaleMin="1" mergeLines="1" fontMaxPixelSize="10000" zIndex="0" fontMinPixelSize="3" obstacle="1" scaleMax="1000000" scaleVisibility="1" displayAll="0" obstacleFactor="1" obstacleType="0" fontLimitPixelSize="0" drawLabels="1" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option name="properties"/>
      ...
      <rule active="0" key="{d222a0b7-2bfc-4db5-b3be-418dc8f46072}" filter=" &quot;name&quot; not like 'Finger%'" scalemaxdenom="90000" scalemindenom="1">
        <settings>
          ...
          <rendering upsidedownLabels="0" labelPerPart="0" minFeatureSize="0" maxNumLabels="2000" scaleMin="0" mergeLines="0" fontMaxPixelSize="10000" zIndex="0" fontMinPixelSize="3" obstacle="1" scaleMax="0" scaleVisibility="0" displayAll="1" obstacleFactor="1" obstacleType="1" fontLimitPixelSize="0" drawLabels="1" limitNumLabels="0"/>
          <dd_properties>
            <Option type="Map">
              <Option type="QString" name="name" value=""/>
              <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="3" field="addl_info" name=""/>
    <alias index="4" field="photograph" name=""/>
    <alias index="5" field="fclass" name=""/>
    <alias index="6" field="updated_on" name=""/>
    <alias index="7" field="image_sour" name=""/>
    <alias index="8" field="scale" name=""/>
    <alias index="9" field="image_year" name=""/>
    <alias index="10" field="a_br" name=""/>
    <alias index="11" field="imp" name=""/>
    <alias index="12" field="country" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="imp" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="imp" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="country" notnull_strength="0" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;name&quot;" sortOrder="1">
    <columns>
      ...
      <column type="field" width="354" name="name" hidden="0"/>
      ...
      <column type="field" width="-1" name="imp" hidden="0"/>
      <column type="field" width="-1" name="country" hidden="0"/>
    </columns>
