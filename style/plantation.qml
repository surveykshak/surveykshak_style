...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="fill" clip_to_extent="1" alpha="1" name="0">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          ...
          <prop v="200,241,143,225" k="color"/>
  ...
  <aliases>
    ...
    <alias index="4" field="gen_area" name=""/>
    <alias index="5" field="type" name=""/>
    <alias index="6" field="sorce_info" name=""/>
    <alias index="7" field="avg_ht" name=""/>
    <alias index="8" field="avg_thk" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="gen_area" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="gen_area" notnull_strength="0" constraints="0"/>
