...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="TopoSymbol/HAND_PUMP.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="10" field="depth" name=""/>
    <alias index="11" field="instln_auth" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="instln_auth" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="instln_auth" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="instln_auth"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="instln_auth" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="instln_auth" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="instln_auth"/>
