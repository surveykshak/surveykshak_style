...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="5" field="maint_auth" name=""/>
    <alias index="6" field="sorce_info" name=""/>
    <alias index="7" field="ht_frm_wtr" name=""/>
    <alias index="8" field="depth_wtr" name=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="ht_frm_wtr" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="depth_wtr" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="ht_frm_wtr"/>
    <constraint exp="" desc="" field="depth_wtr"/>
