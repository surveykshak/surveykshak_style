...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="FontMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="ESRI Cartography" k="font"/>
  ...
  <aliases>
    ...
    <alias index="2" field="image_sour" name=""/>
    <alias index="3" field="scale" name=""/>
    <alias index="4" field="image_year" name=""/>
    <alias index="5" field="a_br" name=""/>
    <alias index="6" field="fclass" name=""/>
    <alias index="7" field="unique_id" name=""/>
    <alias index="8" field="location" name=""/>
    <alias index="9" field="area_sq_km" name=""/>
    <alias index="10" field="addl_info" name=""/>
    <alias index="11" field="photograph" name=""/>
