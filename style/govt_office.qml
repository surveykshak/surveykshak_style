...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="4" field="town_uid" name=""/>
    <alias index="5" field="mobile_no" name=""/>
    <alias index="6" field="tel_no_off" name=""/>
    <alias index="7" field="tel_no_res" name=""/>
    <alias index="8" field="sorce_info" name=""/>
    <alias index="9" field="addl_info" name=""/>
    <alias index="10" field="photograph" name=""/>
    <alias index="11" field="updated_on" name=""/>
    <alias index="12" field="image_sour" name=""/>
    <alias index="13" field="scale" name=""/>
    <alias index="14" field="image_year" name=""/>
    <alias index="15" field="a_br" name=""/>
    <alias index="16" field="fclass" name=""/>
    <alias index="17" field="head_name" name=""/>
    <alias index="18" field="department" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="town_uid" applyOnUpdate="0"/>
    ...
    <default expression="" field="department" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="town_uid" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="department" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="town_uid"/>
    ...
    <constraint exp="" desc="" field="department"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="town_uid" hidden="0"/>
      ...
      <column type="field" width="-1" name="department" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="department" editable="1"/>
    ...
    <field name="town_uid" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="department"/>
    ...
    <field labelOnTop="0" name="town_uid"/>
