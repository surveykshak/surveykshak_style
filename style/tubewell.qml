...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
          <prop v="0" k="angle"/>
          <prop v="127,209,224,255" k="color"/>
          ...
          <prop v="127,209,224,255" k="outline_color"/>
  ...
  <aliases>
    ...
    <alias index="4" field="diameter" name=""/>
    <alias index="5" field="contr_auth" name=""/>
    <alias index="6" field="potability" name=""/>
    <alias index="7" field="elcity_avl" name=""/>
    <alias index="8" field="storage" name=""/>
    <alias index="9" field="storage_l" name=""/>
    <alias index="10" field="sorce_info" name=""/>
    <alias index="11" field="disch_rate" name=""/>
    <alias index="12" field="perenlty" name=""/>
    <alias index="13" field="addl_info" name=""/>
    <alias index="14" field="photograph" name=""/>
    <alias index="15" field="updated_on" name=""/>
    <alias index="16" field="image_source" name=""/>
    <alias index="17" field="scale" name=""/>
    <alias index="18" field="image_year" name=""/>
    <alias index="19" field="fclass" name=""/>
    <alias index="20" field="a_br" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="elcity_avl" applyOnUpdate="0"/>
    <default expression="" field="storage" applyOnUpdate="0"/>
    <default expression="" field="storage_l" applyOnUpdate="0"/>
    <default expression="" field="sorce_info" applyOnUpdate="0"/>
    <default expression="" field="disch_rate" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="diameter" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="elcity_avl" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="storage" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="storage_l" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="sorce_info" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="disch_rate" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="elcity_avl"/>
    <constraint exp="" desc="" field="storage"/>
    <constraint exp="" desc="" field="storage_l"/>
    <constraint exp="" desc="" field="sorce_info"/>
    <constraint exp="" desc="" field="disch_rate"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="elcity_avl" hidden="0"/>
      <column type="field" width="-1" name="storage" hidden="0"/>
      <column type="field" width="-1" name="storage_l" hidden="0"/>
      <column type="field" width="-1" name="sorce_info" hidden="0"/>
      <column type="field" width="-1" name="disch_rate" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="disch_rate" editable="1"/>
    <field name="elcity_avl" editable="1"/>
    ...
    <field name="storage" editable="1"/>
    <field name="storage_l" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="disch_rate"/>
    <field labelOnTop="0" name="elcity_avl"/>
    ...
    <field labelOnTop="0" name="storage"/>
    <field labelOnTop="0" name="storage_l"/>
