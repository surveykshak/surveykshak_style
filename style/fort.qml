...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="TopoSymbol/FORT.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="3" field="fort_type" name=""/>
    <alias index="4" field="location" name=""/>
    <alias index="5" field="imp_instln" name=""/>
    <alias index="6" field="area_sq_m" name=""/>
    <alias index="7" field="sorce_info" name=""/>
    <alias index="8" field="addl_info" name=""/>
    <alias index="9" field="photograph" name=""/>
    <alias index="10" field="updated_on" name=""/>
    <alias index="11" field="image_source" name=""/>
    <alias index="12" field="scale" name=""/>
    <alias index="13" field="image_year" name=""/>
    <alias index="14" field="a_br" name=""/>
    <alias index="15" field="fclass" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="fort_type" applyOnUpdate="0"/>
    <default expression="" field="location" applyOnUpdate="0"/>
    <default expression="" field="imp_instln" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="fort_type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="location" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="imp_instln" notnull_strength="0" constraints="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="fort_type" hidden="0"/>
      <column type="field" width="-1" name="imp_instln" hidden="0"/>
