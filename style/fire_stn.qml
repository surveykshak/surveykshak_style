...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          <prop v="0" k="angle"/>
          <prop v="167,251,9,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="amenity/amenity_firestation3.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="3" field="truck_nos" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="truck_nos" applyOnUpdate="0"/>
    ...
    <default expression="" field="firemen" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="truck_nos" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="firemen" notnull_strength="0" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="truck_nos" hidden="0"/>
      <column type="field" width="-1" name="a_br" hidden="0"/>
      <column type="field" width="-1" name="location" hidden="0"/>
      <column type="field" width="-1" name="firemen" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="truck_nos" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="firemen"/>
    ...
    <field labelOnTop="0" name="truck_nos"/>
