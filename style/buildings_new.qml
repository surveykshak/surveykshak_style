...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="singleSymbol" forceraster="0" symbollevels="0">
    <symbols>
      <symbol type="fill" clip_to_extent="1" alpha="0.5" name="0">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="255,165,202,255" k="color"/>
  ...
  <aliases>
    ...
    <alias index="5" field="vill_pt_id" name=""/>
    <alias index="6" field="floor" name=""/>
    <alias index="7" field="head_name" name=""/>
    ...
    <alias index="16" field="updated_by" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="vill_pt_id" applyOnUpdate="0"/>
    ...
    <default expression="" field="updated_by" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="vill_pt_id" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="floor" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="updated_by" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="vill_pt_id"/>
    <constraint exp="" desc="" field="floor"/>
