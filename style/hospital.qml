...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement placementFlags="9" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="1" xOffset="4" repeatDistance="0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MM" dist="3" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" centroidInside="0" preserveRotation="1" priority="4" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="4" rotationAngle="0" offsetType="0" quadOffset="7"/>
      <rendering upsidedownLabels="0" labelPerPart="0" minFeatureSize="3" maxNumLabels="2000" scaleMin="1" mergeLines="1" fontMaxPixelSize="10000" zIndex="0" fontMinPixelSize="3" obstacle="1" scaleMax="5000" scaleVisibility="1" displayAll="0" obstacleFactor="1" obstacleType="0" fontLimitPixelSize="0" drawLabels="1" limitNumLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="2" field="location" name=""/>
    <alias index="3" field="name" name=""/>
    <alias index="4" field="capacity" name=""/>
    <alias index="5" field="no_of_beds" name=""/>
    <alias index="6" field="no_doctors" name=""/>
    <alias index="7" field="ot_avl" name=""/>
    <alias index="8" field="type" name=""/>
    <alias index="9" field="address" name=""/>
    <alias index="10" field="tele_no" name=""/>
    <alias index="11" field="icu_avl" name=""/>
    <alias index="12" field="crisis_bed" name=""/>
    <alias index="13" field="trauma_cen" name=""/>
    <alias index="14" field="mortuary" name=""/>
    <alias index="15" field="near_stn" name=""/>
    <alias index="16" field="near_airfd" name=""/>
    <alias index="17" field="near_helpd" name=""/>
    <alias index="18" field="sorce_info" name=""/>
    <alias index="19" field="addl_info" name=""/>
    <alias index="20" field="photograph" name=""/>
    <alias index="21" field="attr_fill" name=""/>
    <alias index="22" field="updated_on" name=""/>
    <alias index="23" field="image_source" name=""/>
    <alias index="24" field="scale" name=""/>
    <alias index="25" field="image_year" name=""/>
    <alias index="26" field="a_br" name=""/>
    <alias index="27" field="fclass" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="no_of_beds" applyOnUpdate="0"/>
    <default expression="" field="no_doctors" applyOnUpdate="0"/>
    <default expression="" field="ot_avl" applyOnUpdate="0"/>
    <default expression="" field="type" applyOnUpdate="0"/>
    <default expression="" field="address" applyOnUpdate="0"/>
    <default expression="" field="tele_no" applyOnUpdate="0"/>
    <default expression="" field="icu_avl" applyOnUpdate="0"/>
    <default expression="" field="crisis_bed" applyOnUpdate="0"/>
    <default expression="" field="trauma_cen" applyOnUpdate="0"/>
    <default expression="" field="mortuary" applyOnUpdate="0"/>
    <default expression="" field="near_stn" applyOnUpdate="0"/>
    <default expression="" field="near_airfd" applyOnUpdate="0"/>
    <default expression="" field="near_helpd" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="no_of_beds" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="no_doctors" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="ot_avl" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="address" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="tele_no" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="icu_avl" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="crisis_bed" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="trauma_cen" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="mortuary" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="near_stn" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="near_airfd" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="near_helpd" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="no_of_beds"/>
    <constraint exp="" desc="" field="no_doctors"/>
    <constraint exp="" desc="" field="ot_avl"/>
    <constraint exp="" desc="" field="type"/>
    <constraint exp="" desc="" field="address"/>
    <constraint exp="" desc="" field="tele_no"/>
    <constraint exp="" desc="" field="icu_avl"/>
    <constraint exp="" desc="" field="crisis_bed"/>
    <constraint exp="" desc="" field="trauma_cen"/>
    <constraint exp="" desc="" field="mortuary"/>
    <constraint exp="" desc="" field="near_stn"/>
    <constraint exp="" desc="" field="near_airfd"/>
    <constraint exp="" desc="" field="near_helpd"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="capacity" hidden="0"/>
      <column type="field" width="-1" name="no_of_beds" hidden="0"/>
      <column type="field" width="-1" name="no_doctors" hidden="0"/>
      <column type="field" width="-1" name="ot_avl" hidden="0"/>
      <column type="field" width="-1" name="type" hidden="0"/>
      <column type="field" width="-1" name="address" hidden="0"/>
      <column type="field" width="-1" name="tele_no" hidden="0"/>
      <column type="field" width="-1" name="icu_avl" hidden="0"/>
      <column type="field" width="-1" name="crisis_bed" hidden="0"/>
      <column type="field" width="-1" name="trauma_cen" hidden="0"/>
      <column type="field" width="-1" name="mortuary" hidden="0"/>
      <column type="field" width="-1" name="near_stn" hidden="0"/>
      <column type="field" width="-1" name="near_airfd" hidden="0"/>
      <column type="field" width="-1" name="near_helpd" hidden="0"/>
      ...
      <column type="field" width="-1" name="attr_fill" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="mortuary" editable="1"/>
    <field name="name" editable="1"/>
    <field name="near_airfd" editable="1"/>
    <field name="near_helpd" editable="1"/>
    <field name="near_stn" editable="1"/>
    <field name="no_doctors" editable="1"/>
    <field name="no_of_beds" editable="1"/>
    <field name="ot_avl" editable="1"/>
    <field name="photograph" editable="1"/>
    <field name="scale" editable="1"/>
    <field name="sorce_info" editable="1"/>
    <field name="tele_no" editable="1"/>
    <field name="trauma_cen" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="mortuary"/>
    <field labelOnTop="0" name="name"/>
    <field labelOnTop="0" name="near_airfd"/>
    <field labelOnTop="0" name="near_helpd"/>
    <field labelOnTop="0" name="near_stn"/>
    <field labelOnTop="0" name="no_doctors"/>
    <field labelOnTop="0" name="no_of_beds"/>
    <field labelOnTop="0" name="ot_avl"/>
    ...
    <field labelOnTop="0" name="trauma_cen"/>
