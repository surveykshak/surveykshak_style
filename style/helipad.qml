...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="TopoSymbol/HELIPAD.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="5" field="surface" name=""/>
    <alias index="6" field="heptr_type" name=""/>
    <alias index="7" field="length" name=""/>
    <alias index="8" field="width" name=""/>
    <alias index="9" field="elevation" name=""/>
    <alias index="10" field="refueling" name=""/>
    <alias index="11" field="in_use" name=""/>
    <alias index="12" field="maint_auth" name=""/>
    <alias index="13" field="heaviest" name=""/>
    <alias index="14" field="fmn_resp" name=""/>
    <alias index="15" field="unit_id" name=""/>
    <alias index="16" field="sorce_info" name=""/>
    <alias index="17" field="addl_info" name=""/>
    <alias index="18" field="photograph" name=""/>
    <alias index="19" field="updated_on" name=""/>
    <alias index="20" field="image_source" name=""/>
    <alias index="21" field="scale" name=""/>
    <alias index="22" field="image_year" name=""/>
    <alias index="23" field="a_br" name=""/>
    <alias index="24" field="fclass" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="heptr_type" applyOnUpdate="0"/>
    ...
    <default expression="" field="refueling" applyOnUpdate="0"/>
    <default expression="" field="in_use" applyOnUpdate="0"/>
    <default expression="" field="maint_auth" applyOnUpdate="0"/>
    <default expression="" field="heaviest" applyOnUpdate="0"/>
    <default expression="" field="fmn_resp" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="heptr_type" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="refueling" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="in_use" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="maint_auth" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="heaviest" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="fmn_resp" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="unit_id" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="heptr_type"/>
    <constraint exp="" desc="" field="length"/>
    <constraint exp="" desc="" field="width"/>
    <constraint exp="" desc="" field="elevation"/>
    <constraint exp="" desc="" field="refueling"/>
    <constraint exp="" desc="" field="in_use"/>
    <constraint exp="" desc="" field="maint_auth"/>
    <constraint exp="" desc="" field="heaviest"/>
    <constraint exp="" desc="" field="fmn_resp"/>
    <constraint exp="" desc="" field="unit_id"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="heptr_type" hidden="0"/>
      <column type="field" width="-1" name="refueling" hidden="0"/>
      <column type="field" width="-1" name="in_use" hidden="0"/>
      <column type="field" width="-1" name="maint_auth" hidden="0"/>
      <column type="field" width="-1" name="heaviest" hidden="0"/>
      <column type="field" width="-1" name="fmn_resp" hidden="0"/>
      <column type="field" width="-1" name="unit_id" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="fmn_resp" editable="1"/>
    <field name="gid" editable="1"/>
    <field name="gmrotation" editable="1"/>
    <field name="heaviest" editable="1"/>
    <field name="heptr_type" editable="1"/>
    <field name="hp_name" editable="1"/>
    <field name="hp_surface" editable="1"/>
    <field name="image_source" editable="1"/>
    <field name="image_year" editable="1"/>
    <field name="in_use" editable="1"/>
    ...
    <field name="refueling" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="fmn_resp"/>
    <field labelOnTop="0" name="gid"/>
    <field labelOnTop="0" name="gmrotation"/>
    <field labelOnTop="0" name="heaviest"/>
    <field labelOnTop="0" name="heptr_type"/>
    <field labelOnTop="0" name="hp_name"/>
    <field labelOnTop="0" name="hp_surface"/>
    <field labelOnTop="0" name="image_source"/>
    <field labelOnTop="0" name="image_year"/>
    <field labelOnTop="0" name="in_use"/>
    ...
    <field labelOnTop="0" name="refueling"/>
