...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="TopoSymbol/RIFLE_RANGE_HEAD (2).svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="3" field="range_type" name=""/>
    <alias index="4" field="facilities" name=""/>
    <alias index="5" field="near_road" name=""/>
    <alias index="6" field="wtr_source" name=""/>
    <alias index="7" field="area_sq_m" name=""/>
    <alias index="8" field="nr_village" name=""/>
    <alias index="9" field="sorce_info" name=""/>
    <alias index="10" field="rotation" name=""/>
    <alias index="11" field="addl_info" name=""/>
    <alias index="12" field="photograph" name=""/>
    <alias index="13" field="updated_on" name=""/>
    <alias index="14" field="image_source" name=""/>
    <alias index="15" field="scale" name=""/>
    <alias index="16" field="image_year" name=""/>
    <alias index="17" field="a_br" name=""/>
    <alias index="18" field="fclass" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="range_type" applyOnUpdate="0"/>
    <default expression="" field="facilities" applyOnUpdate="0"/>
    <default expression="" field="near_road" applyOnUpdate="0"/>
    <default expression="" field="wtr_source" applyOnUpdate="0"/>
    <default expression="" field="area_sq_m" applyOnUpdate="0"/>
    <default expression="" field="nr_village" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="range_type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="facilities" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="near_road" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="wtr_source" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="area_sq_m" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="nr_village" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="range_type"/>
    <constraint exp="" desc="" field="facilities"/>
    <constraint exp="" desc="" field="near_road"/>
    <constraint exp="" desc="" field="wtr_source"/>
    <constraint exp="" desc="" field="area_sq_m"/>
    <constraint exp="" desc="" field="nr_village"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="range_type" hidden="0"/>
      <column type="field" width="-1" name="facilities" hidden="0"/>
      <column type="field" width="-1" name="near_road" hidden="0"/>
      <column type="field" width="-1" name="wtr_source" hidden="0"/>
      <column type="field" width="-1" name="nr_village" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="facilities"/>
    ...
    <field labelOnTop="0" name="nr_village"/>
    <field labelOnTop="0" name="photograph"/>
    <field labelOnTop="0" name="range_type"/>
