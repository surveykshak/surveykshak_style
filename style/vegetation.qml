...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="fill" clip_to_extent="1" alpha="1" name="0">
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          ...
          <prop v="183,225,123,206" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="212,208,200,0" k="outline_color"/>
  ...
  <aliases>
    ...
    <alias index="2" field="area_sq_m" name=""/>
    <alias index="3" field="maint_auth" name=""/>
    <alias index="4" field="type" name=""/>
    <alias index="5" field="name" name=""/>
    <alias index="6" field="sorce_info" name=""/>
    <alias index="7" field="aas_id" name=""/>
    <alias index="8" field="tree_type" name=""/>
    <alias index="9" field="undrgrowth" name=""/>
    <alias index="10" field="avg_ht" name=""/>
    <alias index="11" field="thickness" name=""/>
    <alias index="12" field="avg_thk" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="tree_type" applyOnUpdate="0"/>
    <default expression="" field="undrgrowth" applyOnUpdate="0"/>
    <default expression="" field="avg_ht" applyOnUpdate="0"/>
    <default expression="" field="thickness" applyOnUpdate="0"/>
    <default expression="" field="avg_thk" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="tree_type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="undrgrowth" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="avg_ht" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="thickness" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="avg_thk" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tree_type"/>
    <constraint exp="" desc="" field="undrgrowth"/>
    <constraint exp="" desc="" field="avg_ht"/>
    <constraint exp="" desc="" field="thickness"/>
    <constraint exp="" desc="" field="avg_thk"/>
