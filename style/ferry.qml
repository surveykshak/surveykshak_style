...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="3" field="width_river" name=""/>
    ...
    <alias index="13" field="from" name=""/>
    <alias index="14" field="to" name=""/>
    <alias index="15" field="type" name=""/>
    <alias index="16" field="seasonality" name=""/>
    <alias index="17" field="journy_time" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="width_river" applyOnUpdate="0"/>
    ...
    <default expression="" field="seasonality" applyOnUpdate="0"/>
    <default expression="" field="journy_time" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="width_river" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="from" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="to" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="seasonality" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="journy_time" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="gid"/>
    <constraint exp="" desc="" field="unique_id"/>
    <constraint exp="" desc="" field="aas_id"/>
    <constraint exp="" desc="" field="width_river"/>
    ...
    <constraint exp="" desc="" field="seasonality"/>
    <constraint exp="" desc="" field="journy_time"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
