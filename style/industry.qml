...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="symbol/industry.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="5" field="updated_on" name=""/>
    <alias index="6" field="image_sour" name=""/>
    <alias index="7" field="scale" name=""/>
    <alias index="8" field="image_year" name=""/>
    <alias index="9" field="a_br" name=""/>
    <alias index="10" field="fclass" name=""/>
    <alias index="11" field="type" name=""/>
    <alias index="12" field="worker_nos" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="worker_nos" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="worker_nos" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="worker_nos"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="184" name="name" hidden="0"/>
      ...
      <column type="field" width="-1" name="worker_nos" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="worker_nos" editable="1"/>
  </editable>
  <labelOnTop>
    ...
    <field labelOnTop="0" name="worker_nos"/>
  </labelOnTop>
  <widgets/>
