...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="C:/Program Files/SURVEYKSHAK 3.1/apps/qgis/svg/TopoSymbol/VIADUCT.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="4" field="along_type" name=""/>
    <alias index="5" field="upon_uid" name=""/>
    <alias index="6" field="along_uid" name=""/>
    <alias index="7" field="addl_info" name=""/>
    <alias index="8" field="photograph" name=""/>
    <alias index="9" field="rotation" name=""/>
    ...
    <alias index="14" field="fclass" name=""/>
    <alias index="15" field="a_br" name=""/>
    <alias index="16" field="length" name=""/>
    <alias index="17" field="pier_nos" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="pier_nos" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="pier_nos" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="pier_nos"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="pier_nos" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="pier_nos" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="pier_nos"/>
