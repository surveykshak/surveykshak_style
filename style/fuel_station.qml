...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="gpsicons/conveneince.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="4" field="tank_nos" name=""/>
    ...
    <alias index="11" field="image_sour" name=""/>
    ...
    <alias index="16" field="machine" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="tank_nos" applyOnUpdate="0"/>
    ...
    <default expression="" field="machine" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="tank_nos" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="machine" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="tank_nos"/>
    ...
    <constraint exp="" desc="" field="machine"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;type&quot;" sortOrder="1">
    <columns>
      ...
      <column type="field" width="-1" name="tank_nos" hidden="0"/>
      ...
      <column type="field" width="-1" name="machine" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="tank_nos" editable="1"/>
    <field name="type" editable="1"/>
    <field name="unique_id" editable="1"/>
    <field name="unit_nos" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="machine"/>
    ...
    <field labelOnTop="0" name="tank_nos"/>
    <field labelOnTop="0" name="type"/>
    <field labelOnTop="0" name="unique_id"/>
    <field labelOnTop="0" name="unit_nos"/>
