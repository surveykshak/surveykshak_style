...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement placementFlags="9" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="1" xOffset="5" repeatDistance="0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MM" dist="3" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" centroidInside="0" preserveRotation="1" priority="8" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="5" rotationAngle="0" offsetType="0" quadOffset="7"/>
      <rendering upsidedownLabels="0" labelPerPart="0" minFeatureSize="3" maxNumLabels="2000" scaleMin="1" mergeLines="1" fontMaxPixelSize="10000" zIndex="0" fontMinPixelSize="3" obstacle="1" scaleMax="100000" scaleVisibility="1" displayAll="0" obstacleFactor="1" obstacleType="0" fontLimitPixelSize="0" drawLabels="1" limitNumLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="2" field="upon_uid" name=""/>
    <alias index="3" field="name" name=""/>
    <alias index="4" field="to_place_1" name=""/>
    <alias index="5" field="to_place_2" name=""/>
    <alias index="6" field="sfall_begn" name=""/>
    <alias index="7" field="clos_month" name=""/>
    <alias index="8" field="dist_close" name=""/>
    <alias index="9" field="sfall_end" name=""/>
    <alias index="10" field="open_month" name=""/>
    <alias index="11" field="duration" name=""/>
    <alias index="12" field="max_sfall" name=""/>
    <alias index="13" field="elevation" name=""/>
    <alias index="14" field="length" name=""/>
    <alias index="15" field="width" name=""/>
    <alias index="16" field="surface" name=""/>
    <alias index="17" field="two_way" name=""/>
    <alias index="18" field="maint_auth" name=""/>
    <alias index="19" field="close_from" name=""/>
    <alias index="20" field="close_to" name=""/>
    <alias index="21" field="sorce_info" name=""/>
    <alias index="22" field="addl_info" name=""/>
    <alias index="23" field="photograph" name=""/>
    <alias index="24" field="updated_on" name=""/>
    <alias index="25" field="image_source" name=""/>
    <alias index="26" field="scale" name=""/>
    <alias index="27" field="image_year" name=""/>
    <alias index="28" field="a_br" name=""/>
    <alias index="29" field="fclass" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="to_place_1" applyOnUpdate="0"/>
    <default expression="" field="to_place_2" applyOnUpdate="0"/>
    <default expression="" field="sfall_begn" applyOnUpdate="0"/>
    <default expression="" field="clos_month" applyOnUpdate="0"/>
    <default expression="" field="dist_close" applyOnUpdate="0"/>
    <default expression="" field="sfall_end" applyOnUpdate="0"/>
    <default expression="" field="open_month" applyOnUpdate="0"/>
    <default expression="" field="duration" applyOnUpdate="0"/>
    <default expression="" field="max_sfall" applyOnUpdate="0"/>
    ...
    <default expression="" field="two_way" applyOnUpdate="0"/>
    <default expression="" field="maint_auth" applyOnUpdate="0"/>
    <default expression="" field="close_from" applyOnUpdate="0"/>
    <default expression="" field="close_to" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="upon_uid" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="name" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="to_place_1" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="to_place_2" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="sfall_begn" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="clos_month" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="dist_close" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="sfall_end" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="open_month" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="duration" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="max_sfall" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="two_way" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="maint_auth" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="close_from" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="close_to" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="upon_uid"/>
    <constraint exp="" desc="" field="name"/>
    <constraint exp="" desc="" field="to_place_1"/>
    <constraint exp="" desc="" field="to_place_2"/>
    <constraint exp="" desc="" field="sfall_begn"/>
    <constraint exp="" desc="" field="clos_month"/>
    <constraint exp="" desc="" field="dist_close"/>
    <constraint exp="" desc="" field="sfall_end"/>
    <constraint exp="" desc="" field="open_month"/>
    <constraint exp="" desc="" field="duration"/>
    <constraint exp="" desc="" field="max_sfall"/>
    ...
    <constraint exp="" desc="" field="two_way"/>
    <constraint exp="" desc="" field="maint_auth"/>
    <constraint exp="" desc="" field="close_from"/>
    <constraint exp="" desc="" field="close_to"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="upon_uid" hidden="0"/>
      <column type="field" width="-1" name="to_place_1" hidden="0"/>
      <column type="field" width="-1" name="to_place_2" hidden="0"/>
      <column type="field" width="-1" name="sfall_begn" hidden="0"/>
      <column type="field" width="-1" name="clos_month" hidden="0"/>
      <column type="field" width="-1" name="dist_close" hidden="0"/>
      <column type="field" width="-1" name="sfall_end" hidden="0"/>
      <column type="field" width="-1" name="open_month" hidden="0"/>
      <column type="field" width="-1" name="duration" hidden="0"/>
      <column type="field" width="-1" name="max_sfall" hidden="0"/>
      <column type="field" width="-1" name="surface" hidden="0"/>
      <column type="field" width="-1" name="two_way" hidden="0"/>
      <column type="field" width="-1" name="maint_auth" hidden="0"/>
      <column type="field" width="-1" name="close_from" hidden="0"/>
      <column type="field" width="-1" name="close_to" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="altitude_m" editable="1"/>
    <field name="attr_fill" editable="1"/>
    <field name="clos_month" editable="1"/>
    <field name="close_from" editable="1"/>
    <field name="close_to" editable="1"/>
    <field name="dist_close" editable="1"/>
    ...
    <field name="max_sfall" editable="1"/>
    <field name="name" editable="1"/>
    <field name="open_month" editable="1"/>
    <field name="pass_name" editable="1"/>
    <field name="photograph" editable="1"/>
    <field name="scale" editable="1"/>
    <field name="sfall_begn" editable="1"/>
    <field name="sfall_end" editable="1"/>
    <field name="sorce_info" editable="1"/>
    <field name="surface" editable="1"/>
    <field name="to_place_1" editable="1"/>
    <field name="to_place_2" editable="1"/>
    <field name="two_way" editable="1"/>
    <field name="unique_id" editable="1"/>
    <field name="updated_by" editable="1"/>
    <field name="updated_on" editable="1"/>
    <field name="upon_uid" editable="1"/>
    <field name="width" editable="1"/>
    <field name="width_m" editable="1"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="a_br"/>
    <field labelOnTop="0" name="addl_info"/>
    <field labelOnTop="0" name="altitude_m"/>
    <field labelOnTop="0" name="attr_fill"/>
    <field labelOnTop="0" name="clos_month"/>
    <field labelOnTop="0" name="close_from"/>
    <field labelOnTop="0" name="close_to"/>
    <field labelOnTop="0" name="dist_close"/>
    ...
    <field labelOnTop="0" name="open_month"/>
    <field labelOnTop="0" name="pass_name"/>
    ...
    <field labelOnTop="0" name="to_place_1"/>
    <field labelOnTop="0" name="to_place_2"/>
    ...
    <field labelOnTop="0" name="width_m"/>
  </labelOnTop>
  <widgets/>
  <previewExpression>"pass_name"</previewExpression>
  <mapTip></mapTip>
