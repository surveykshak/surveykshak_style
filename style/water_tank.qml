...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="4" field="potability" name=""/>
    <alias index="5" field="perenlty" name=""/>
    <alias index="6" field="lined" name=""/>
    <alias index="7" field="sorce_info" name=""/>
    <alias index="8" field="depth_summ" name=""/>
    <alias index="9" field="depth_rain" name=""/>
    <alias index="10" field="depth_wint" name=""/>
    <alias index="11" field="name" name=""/>
    <alias index="12" field="width" name=""/>
    <alias index="13" field="area_sq_m" name=""/>
    ...
    <alias index="21" field="fclass" name=""/>
    <alias index="22" field="a_br" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="potability" applyOnUpdate="0"/>
    <default expression="" field="perenlty" applyOnUpdate="0"/>
    <default expression="" field="lined" applyOnUpdate="0"/>
    ...
    <default expression="" field="area_sq_m" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="potability" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="perenlty" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="lined" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="area_sq_m" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="potability"/>
    <constraint exp="" desc="" field="perenlty"/>
    <constraint exp="" desc="" field="lined"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;photograph&quot;" sortOrder="0">
    <columns>
      <column type="field" width="-1" name="gid" hidden="0"/>
      <column type="field" width="-1" name="unique_id" hidden="0"/>
      <column type="field" width="-1" name="potability" hidden="0"/>
      <column type="field" width="-1" name="perenlty" hidden="0"/>
      <column type="field" width="-1" name="lined" hidden="0"/>
      <column type="field" width="-1" name="sorce_info" hidden="0"/>
      <column type="field" width="-1" name="depth_summ" hidden="0"/>
      <column type="field" width="-1" name="depth_rain" hidden="0"/>
      <column type="field" width="-1" name="depth_wint" hidden="0"/>
      ...
      <column type="field" width="-1" name="area_sq_m" hidden="0"/>
      <column type="field" width="-1" name="bank_ht" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="bank_ht" editable="1"/>
    <field name="bank_ht_m" editable="1"/>
    <field name="depth_rain" editable="1"/>
    <field name="depth_summ" editable="1"/>
    <field name="depth_wint" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="bank_ht"/>
    <field labelOnTop="0" name="bank_ht_m"/>
    <field labelOnTop="0" name="depth_rain"/>
    <field labelOnTop="0" name="depth_summ"/>
    <field labelOnTop="0" name="depth_wint"/>
