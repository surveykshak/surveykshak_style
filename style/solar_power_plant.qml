...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{7f793456-ff24-47a0-9718-7c53ae65a2ce}">
      <rule key="{0c944ab8-e909-4c5b-aea2-e825872e0ef1}" scalemaxdenom="5000" symbol="0" scalemindenom="1"/>
      <rule key="{4146f46b-1d40-4470-8e6b-244dacab1bb9}" scalemaxdenom="25000" symbol="1" scalemindenom="1"/>
    </rules>
    <symbols>
        ...
        <layer class="CentroidFill" pass="0" locked="0" enabled="1">
          ...
          <symbol type="marker" clip_to_extent="1" alpha="1" name="@0@0">
            <layer class="SvgMarker" pass="0" locked="0" enabled="1">
              ...
              <prop v="symbol/solar-panel-svgrepo-com.svg" k="name"/>
              <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="3" field="image_sour" name=""/>
    <alias index="4" field="scale" name=""/>
    <alias index="5" field="image_year" name=""/>
    <alias index="6" field="a_br" name=""/>
    <alias index="7" field="fclass" name=""/>
    <alias index="8" field="unique_id" name=""/>
    <alias index="9" field="capacity" name=""/>
    <alias index="10" field="panel_nos" name=""/>
    <alias index="11" field="maint_auth" name=""/>
    <alias index="12" field="location" name=""/>
    <alias index="13" field="tele_no" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="panel_nos" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="panel_nos" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="panel_nos"/>
