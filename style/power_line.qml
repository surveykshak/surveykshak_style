...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
        ...
        <layer class="MarkerLine" pass="0" locked="0" enabled="1">
          ...
          <symbol type="marker" clip_to_extent="1" alpha="1" name="@0@1">
            <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
              ...
              <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
              <prop v="MM" k="offset_unit"/>
              <prop v="92,89,101,255" k="outline_color"/>
  ...
  <aliases>
    ...
    <alias index="4" field="rating_kv" name=""/>
    <alias index="5" field="pole_type" name=""/>
    <alias index="6" field="grnd_clear" name=""/>
    <alias index="7" field="pole_ht" name=""/>
    <alias index="8" field="supply_typ" name=""/>
    <alias index="9" field="maint_auth" name=""/>
    <alias index="10" field="feeder_gr" name=""/>
    <alias index="11" field="feeder_stn" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="rating_kv" applyOnUpdate="0"/>
    <default expression="" field="pole_type" applyOnUpdate="0"/>
    <default expression="" field="grnd_clear" applyOnUpdate="0"/>
    <default expression="" field="pole_ht" applyOnUpdate="0"/>
    <default expression="" field="supply_typ" applyOnUpdate="0"/>
    <default expression="" field="maint_auth" applyOnUpdate="0"/>
    <default expression="" field="feeder_gr" applyOnUpdate="0"/>
    <default expression="" field="feeder_stn" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="rating_kv" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="pole_type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="grnd_clear" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="pole_ht" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="supply_typ" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="maint_auth" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="feeder_gr" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="feeder_stn" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="rating_kv"/>
    <constraint exp="" desc="" field="pole_type"/>
    <constraint exp="" desc="" field="grnd_clear"/>
    <constraint exp="" desc="" field="pole_ht"/>
    <constraint exp="" desc="" field="supply_typ"/>
    <constraint exp="" desc="" field="maint_auth"/>
    <constraint exp="" desc="" field="feeder_gr"/>
    <constraint exp="" desc="" field="feeder_stn"/>
