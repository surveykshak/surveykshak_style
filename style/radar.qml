...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{a029c9d7-2624-48a6-b266-0980ea65e4fb}">
      <rule key="{a3c8b2e9-f305-46b1-b437-0d52bb212988}" scalemaxdenom="3091755" symbol="0" scalemindenom="25000"/>
      <rule label="Radar" key="{a7a8b4bb-f917-4d09-bba2-becad52837df}" scalemaxdenom="25000" symbol="1" scalemindenom="1"/>
    </rules>
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="symbol/radar2.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="3" field="range" name=""/>
    <alias index="4" field="addl_info" name=""/>
    <alias index="5" field="image_sour" name=""/>
    ...
    <alias index="10" field="unique_id" name=""/>
    <alias index="11" field="location" name=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="251" name="addl_info" hidden="0"/>
