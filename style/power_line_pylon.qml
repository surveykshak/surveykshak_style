...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
  ...
  <aliases>
    ...
    <alias index="2" field="pylon_type" name=""/>
    <alias index="3" field="line_type" name=""/>
    ...
    <alias index="13" field="pylon_length" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="pylon_type" applyOnUpdate="0"/>
    ...
    <default expression="" field="pylon_length" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="pylon_type" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="line_type" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="pylon_length" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="gid"/>
    <constraint exp="" desc="" field="unique_id"/>
    <constraint exp="" desc="" field="pylon_type"/>
    ...
    <constraint exp="" desc="" field="pylon_length"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="pylon_type" hidden="0"/>
      <column type="field" width="-1" name="line_type" hidden="0"/>
      ...
      <column type="field" width="-1" name="pylon_length" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="pylon_length" editable="1"/>
    <field name="pylon_type" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="pylon_length"/>
    <field labelOnTop="0" name="pylon_type"/>
