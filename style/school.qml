...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="symbol/school.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement placementFlags="10" distUnits="MM" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="6" xOffset="0" repeatDistance="0" centroidWhole="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" offsetUnits="MM" dist="4" maxCurvedCharAngleIn="25" repeatDistanceUnits="MM" centroidInside="0" preserveRotation="1" priority="5" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" rotationAngle="0" offsetType="0" quadOffset="4"/>
      <rendering upsidedownLabels="0" labelPerPart="0" minFeatureSize="0" maxNumLabels="2000" scaleMin="0" mergeLines="0" fontMaxPixelSize="10000" zIndex="0" fontMinPixelSize="3" obstacle="1" scaleMax="5000" scaleVisibility="1" displayAll="0" obstacleFactor="1" obstacleType="1" fontLimitPixelSize="0" drawLabels="1" limitNumLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="4" field="no_child" name=""/>
    <alias index="5" field="no_staff" name=""/>
    <alias index="6" field="no_vehs" name=""/>
    <alias index="7" field="no_rooms" name=""/>
    <alias index="8" field="no_floors" name=""/>
    <alias index="9" field="addl_info" name=""/>
    <alias index="10" field="photograph" name=""/>
    <alias index="11" field="fclass" name=""/>
    <alias index="12" field="updated_on" name=""/>
    <alias index="13" field="image_sour" name=""/>
    <alias index="14" field="scale" name=""/>
    <alias index="15" field="image_year" name=""/>
    <alias index="16" field="a_br" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="no_child" applyOnUpdate="0"/>
    <default expression="" field="no_staff" applyOnUpdate="0"/>
    <default expression="" field="no_vehs" applyOnUpdate="0"/>
    <default expression="" field="no_rooms" applyOnUpdate="0"/>
    <default expression="" field="no_floors" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="no_child" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="no_staff" notnull_strength="0" constraints="0"/>
    ...
    <constraint unique_strength="0" exp_strength="0" field="no_floors" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="no_child"/>
    <constraint exp="" desc="" field="no_staff"/>
    <constraint exp="" desc="" field="no_vehs"/>
    <constraint exp="" desc="" field="no_rooms"/>
    <constraint exp="" desc="" field="no_floors"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="no_child" hidden="0"/>
      <column type="field" width="-1" name="no_staff" hidden="0"/>
      <column type="field" width="-1" name="no_vehs" hidden="0"/>
      <column type="field" width="-1" name="no_rooms" hidden="0"/>
      <column type="field" width="-1" name="no_floors" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="no_child" editable="1"/>
    <field name="no_floors" editable="1"/>
    <field name="no_rooms" editable="1"/>
    <field name="no_staff" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="no_child"/>
    <field labelOnTop="0" name="no_floors"/>
    <field labelOnTop="0" name="no_rooms"/>
    <field labelOnTop="0" name="no_staff"/>
