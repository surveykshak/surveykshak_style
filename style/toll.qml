...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="transport/barrier_toll_booth.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="2" field="along_uid" name=""/>
    <alias index="3" field="along_type" name=""/>
    <alias index="4" field="rotation" name=""/>
    <alias index="5" field="name" name=""/>
    <alias index="6" field="addl_info" name=""/>
    <alias index="7" field="photograph" name=""/>
    <alias index="8" field="updated_on" name=""/>
    <alias index="9" field="image_source" name=""/>
    <alias index="10" field="scale" name=""/>
    <alias index="11" field="image_year" name=""/>
    <alias index="12" field="fclass" name=""/>
    <alias index="13" field="a_br" name=""/>
    <alias index="14" field="gates" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="gates" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="gates" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="gates"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="gates" hidden="0"/>
