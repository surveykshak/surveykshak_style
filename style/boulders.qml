...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="0" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SimpleMarker" pass="0" locked="0" enabled="1">
          <prop v="0" k="angle"/>
          <prop v="179,129,128,255" k="color"/>
          ...
          <prop v="179,129,128,255" k="outline_color"/>
  ...
  <aliases>
    ...
    <alias index="3" field="dimension" name=""/>
    <alias index="4" field="avg_size" name=""/>
    <alias index="5" field="approach" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="dimension" applyOnUpdate="0"/>
    <default expression="" field="avg_size" applyOnUpdate="0"/>
    <default expression="" field="approach" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="dimension" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="avg_size" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="approach" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="dimension"/>
    <constraint exp="" desc="" field="avg_size"/>
    <constraint exp="" desc="" field="approach"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="dimension" hidden="0"/>
      <column type="field" width="-1" name="avg_size" hidden="0"/>
      <column type="field" width="-1" name="approach" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="avg_size" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="avg_size"/>
    <field labelOnTop="0" name="dimension"/>
