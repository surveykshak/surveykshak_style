...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="TopoSymbol/CIRCUIT HOUSE.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="4" field="address" name=""/>
    <alias index="5" field="head_name" name=""/>
    <alias index="6" field="man_power" name=""/>
    <alias index="7" field="no_vehs" name=""/>
    <alias index="8" field="mobile_no" name=""/>
    <alias index="9" field="tel_no_off" name=""/>
    <alias index="10" field="tel_no_res" name=""/>
    <alias index="11" field="kitchen" name=""/>
    <alias index="12" field="maint_auth" name=""/>
    <alias index="13" field="no_rooms" name=""/>
    <alias index="14" field="sorce_info" name=""/>
    <alias index="15" field="addl_info" name=""/>
    <alias index="16" field="photograph" name=""/>
    <alias index="17" field="updated_on" name=""/>
    <alias index="18" field="image_source" name=""/>
    <alias index="19" field="scale" name=""/>
    <alias index="20" field="image_year" name=""/>
    <alias index="21" field="a_br" name=""/>
    <alias index="22" field="fclass" name=""/>
    <alias index="23" field="name" name=""/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="man_power" applyOnUpdate="0"/>
    <default expression="" field="no_vehs" applyOnUpdate="0"/>
    <default expression="" field="mobile_no" applyOnUpdate="0"/>
    <default expression="" field="tel_no_off" applyOnUpdate="0"/>
    <default expression="" field="tel_no_res" applyOnUpdate="0"/>
    <default expression="" field="kitchen" applyOnUpdate="0"/>
    <default expression="" field="maint_auth" applyOnUpdate="0"/>
    <default expression="" field="no_rooms" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="man_power" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="no_vehs" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="mobile_no" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="tel_no_off" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="tel_no_res" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="kitchen" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="maint_auth" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="no_rooms" notnull_strength="0" constraints="0"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="man_power" hidden="0"/>
      <column type="field" width="-1" name="no_vehs" hidden="0"/>
      <column type="field" width="-1" name="mobile_no" hidden="0"/>
      <column type="field" width="-1" name="tel_no_off" hidden="0"/>
      <column type="field" width="-1" name="tel_no_res" hidden="0"/>
      <column type="field" width="-1" name="kitchen" hidden="0"/>
      <column type="field" width="-1" name="maint_auth" hidden="0"/>
      <column type="field" width="-1" name="no_rooms" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="kitchen" editable="1"/>
    <field name="loc_name" editable="1"/>
    <field name="location" editable="1"/>
    <field name="maint_auth" editable="1"/>
    <field name="man_power" editable="1"/>
    <field name="mobile_no" editable="1"/>
    <field name="name" editable="1"/>
    <field name="no_rooms" editable="1"/>
    <field name="no_vehs" editable="1"/>
    <field name="photograph" editable="1"/>
    <field name="scale" editable="1"/>
    <field name="sorce_info" editable="1"/>
    <field name="tel_no_off" editable="1"/>
    <field name="tel_no_res" editable="1"/>
