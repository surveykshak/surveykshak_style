...
<qgis hasScaleBasedVisibilityFlag="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" version="3.0.2-Nihcas C" simplifyMaxScale="1" minScale="15000" simplifyAlgorithm="0" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" maxScale="0">
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0">
        <layer class="SvgMarker" pass="0" locked="0" enabled="1">
          ...
          <prop v="TopoSymbol/WIRELESS_STATION_CONVENTIONAL.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <aliases>
    ...
    <alias index="3" field="location" name=""/>
    <alias index="4" field="height" name=""/>
    <alias index="5" field="type" name=""/>
    <alias index="6" field="name" name=""/>
    <alias index="7" field="contr_auth" name=""/>
    <alias index="8" field="no_antenas" name=""/>
    <alias index="9" field="capacity" name=""/>
    <alias index="10" field="nr_sig_coy" name=""/>
    <alias index="11" field="nr_eme_det" name=""/>
    <alias index="12" field="sorce_info" name=""/>
    <alias index="13" field="interfrnce" name=""/>
    <alias index="14" field="power" name=""/>
    <alias index="15" field="range" name=""/>
    <alias index="16" field="freq_modn" name=""/>
    <alias index="17" field="freq_range" name=""/>
    <alias index="18" field="wave_type" name=""/>
    <alias index="19" field="addl_info" name=""/>
    <alias index="20" field="photograph" name=""/>
    <alias index="21" field="updated_on" name=""/>
    <alias index="22" field="image_source" name=""/>
    <alias index="23" field="scale" name=""/>
    <alias index="24" field="image_year" name=""/>
  ...
  <defaults>
    ...
    <default expression="" field="no_antenas" applyOnUpdate="0"/>
    <default expression="" field="capacity" applyOnUpdate="0"/>
    <default expression="" field="nr_sig_coy" applyOnUpdate="0"/>
    <default expression="" field="nr_eme_det" applyOnUpdate="0"/>
    <default expression="" field="sorce_info" applyOnUpdate="0"/>
    <default expression="" field="interfrnce" applyOnUpdate="0"/>
    <default expression="" field="power" applyOnUpdate="0"/>
    <default expression="" field="range" applyOnUpdate="0"/>
    <default expression="" field="freq_modn" applyOnUpdate="0"/>
    <default expression="" field="freq_range" applyOnUpdate="0"/>
    <default expression="" field="wave_type" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" exp_strength="0" field="no_antenas" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="capacity" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="nr_sig_coy" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="nr_eme_det" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="sorce_info" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="interfrnce" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="power" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="range" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="freq_modn" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="freq_range" notnull_strength="0" constraints="0"/>
    <constraint unique_strength="0" exp_strength="0" field="wave_type" notnull_strength="0" constraints="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="no_antenas"/>
    <constraint exp="" desc="" field="capacity"/>
    <constraint exp="" desc="" field="nr_sig_coy"/>
    <constraint exp="" desc="" field="nr_eme_det"/>
    <constraint exp="" desc="" field="sorce_info"/>
    <constraint exp="" desc="" field="interfrnce"/>
    <constraint exp="" desc="" field="power"/>
    <constraint exp="" desc="" field="range"/>
    <constraint exp="" desc="" field="freq_modn"/>
    <constraint exp="" desc="" field="freq_range"/>
    <constraint exp="" desc="" field="wave_type"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" width="-1" name="contr_auth" hidden="0"/>
      <column type="field" width="-1" name="no_antenas" hidden="0"/>
      <column type="field" width="-1" name="capacity" hidden="0"/>
      <column type="field" width="-1" name="nr_sig_coy" hidden="0"/>
      <column type="field" width="-1" name="nr_eme_det" hidden="0"/>
      <column type="field" width="-1" name="sorce_info" hidden="0"/>
      <column type="field" width="-1" name="interfrnce" hidden="0"/>
      <column type="field" width="-1" name="power" hidden="0"/>
      <column type="field" width="-1" name="range" hidden="0"/>
      <column type="field" width="-1" name="freq_modn" hidden="0"/>
      <column type="field" width="-1" name="freq_range" hidden="0"/>
      <column type="field" width="-1" name="wave_type" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="contr_auth" editable="1"/>
    <field name="direction" editable="1"/>
    <field name="distance" editable="1"/>
    <field name="fclass" editable="1"/>
    <field name="freq_modn" editable="1"/>
    <field name="freq_range" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="contr_auth"/>
    <field labelOnTop="0" name="direction"/>
    <field labelOnTop="0" name="distance"/>
    <field labelOnTop="0" name="fclass"/>
    <field labelOnTop="0" name="freq_modn"/>
    <field labelOnTop="0" name="freq_range"/>
    ...
    <field labelOnTop="0" name="interfrnce"/>
    <field labelOnTop="0" name="loc_name"/>
    <field labelOnTop="0" name="location"/>
    <field labelOnTop="0" name="name"/>
    <field labelOnTop="0" name="no_antenas"/>
    <field labelOnTop="0" name="nr_eme_det"/>
    <field labelOnTop="0" name="nr_sig_coy"/>
