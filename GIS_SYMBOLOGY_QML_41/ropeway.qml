...
<qgis minScale="100000000" version="3.38.2-Grenoble" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="0" symbologyReferenceScale="-1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyLocal="1">
  ...
  <elevation type="IndividualFeatures" symbology="Line" zscale="1" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" extrusion="0" clamping="Terrain" binding="Centroid" respectLayerSymbol="1" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleLine" id="{9fd8ec57-6b98-475a-9dbe-f62a63b298dd}" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol force_rhr="0" type="fill" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{7de8750f-a614-4f0a-b635-eecbaf64344c}" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" id="{88046d12-24b5-4962-9401-9135ab43a4a7}" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1" forceraster="0">
    <symbols>
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="0">
        ...
        <layer enabled="1" pass="0" class="MarkerLine" id="{5323dbe6-5371-4c43-89fd-60573ccfe780}" locked="0">
          <Option type="Map">
          ...
          <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="@0@0">
            ...
            <layer enabled="1" pass="0" class="SimpleMarker" id="{2f23d405-2b04-44d7-8b7b-0699a5fee232}" locked="0">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
        ...
        <layer enabled="1" pass="0" class="MarkerLine" id="{dc88dec9-bb9f-4c56-8da8-e0db3b6ce429}" locked="0">
          <Option type="Map">
            <Option type="QString" value="4" name="average_angle_length"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="average_angle_map_unit_scale"/>
            <Option type="QString" value="MM" name="average_angle_unit"/>
            <Option type="QString" value="0.9" name="interval"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="interval_map_unit_scale"/>
            <Option type="QString" value="MM" name="interval_unit"/>
            <Option type="QString" value="0" name="offset"/>
            <Option type="QString" value="0" name="offset_along_line"/>
          ...
          <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="@0@1">
            ...
            <layer enabled="1" pass="0" class="SimpleMarker" id="{26ab8ba9-7d8a-490e-8f7e-ea92fc644065}" locked="0">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
                <Option type="QString" value="0,0,0,255,rgb:0,0,0,1" name="color"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleLine" id="{019fb385-a809-4fb7-938d-da6bd8319644}" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
    ...
    <DiagramCategory opacity="1" spacing="5" backgroundAlpha="255" showAxis="1" scaleBasedVisibility="0" rotationOffset="270" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacingUnit="MM" barWidth="5" minimumSize="0" penWidth="0" direction="0" lineSizeType="MM" maxScaleDenominator="1e+08" width="15" backgroundColor="#ffffff" penAlpha="255" enabled="0" sizeScale="3x:0,0,0,0,0,0" height="15" penColor="#000000" scaleDependency="Area" minScaleDenominator="0" spacingUnitScale="3x:0,0,0,0,0,0" diagramOrientation="Up" labelPlacementMethod="XHeight">
      ...
      <axisSymbol>
        <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
          ...
          <layer enabled="1" pass="0" class="SimpleLine" id="{c8caf042-85a7-4b65-b45b-9f63b482253e}" locked="0">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="from_name">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="to_name">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="from_name" index="7" name=""/>
    <alias field="unique_id" index="8" name=""/>
    <alias field="img_year" index="9" name=""/>
    <alias field="to_name" index="10" name=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" field="from_name" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="to_name" exp_strength="0" notnull_strength="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="from_name"/>
    ...
    <field reuseLastValue="0" name="to_name"/>
  ...
  <widgets/>
  <previewExpression>"from_name"</previewExpression>
