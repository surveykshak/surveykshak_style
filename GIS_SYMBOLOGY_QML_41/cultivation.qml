...
<qgis minScale="100000000" version="3.38.2-Grenoble" simplifyAlgorithm="0" simplifyDrawingHints="1" maxScale="0" symbologyReferenceScale="-1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyLocal="1">
  ...
  <elevation type="IndividualFeatures" symbology="Line" zscale="1" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" extrusion="0" clamping="Terrain" binding="Centroid" respectLayerSymbol="1" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleLine" id="{03744356-040c-461f-87ba-b4a07a8e1201}" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol force_rhr="0" type="fill" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{ba65165a-f0cd-48de-bf01-6f1caa867d45}" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" id="{fed3e326-fa43-4717-9d19-81c375bebef7}" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1" forceraster="0">
    <symbols>
      <symbol force_rhr="0" type="fill" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{f2a6d5a9-474b-426c-a0a7-102381a35fb2}" locked="0">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="253,255,193,118,rgb:0.99215686274509807,1,0.75686274509803919,0.46274509803921571" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
        ...
        <layer enabled="1" pass="0" class="MarkerLine" id="{96c6113c-56f1-4293-8b1b-dcb371bf9c3c}" locked="0">
          <Option type="Map">
          ...
          <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="@0@1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" pass="0" class="SimpleMarker" id="{5eaf41a9-2826-4078-bccc-86e59aff8c78}" locked="0">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" type="fill" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{b6a22389-0d42-49e9-bf48-567936f6790c}" locked="0">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
    ...
    <DiagramCategory opacity="1" spacing="5" backgroundAlpha="255" showAxis="1" scaleBasedVisibility="0" rotationOffset="270" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacingUnit="MM" barWidth="5" minimumSize="0" penWidth="0" direction="0" lineSizeType="MM" maxScaleDenominator="1e+08" width="15" backgroundColor="#ffffff" penAlpha="255" enabled="0" sizeScale="3x:0,0,0,0,0,0" height="15" penColor="#000000" scaleDependency="Area" minScaleDenominator="0" spacingUnitScale="3x:0,0,0,0,0,0" diagramOrientation="Up" labelPlacementMethod="XHeight">
      ...
      <axisSymbol>
        <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
          ...
          <layer enabled="1" pass="0" class="SimpleLine" id="{ea2ee88c-9e6a-4c77-8967-161ee23d4a09}" locked="0">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <DiagramLayerSettings placement="1" zIndex="0" dist="0" priority="0" linePlacementFlags="18" showAll="1" obstacle="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="reap_month">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="area_sq_m">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="sow_month">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="sector">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="crops">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="reap_month" index="3" name=""/>
    ...
    <alias field="sow_month" index="9" name=""/>
    <alias field="unique_id" index="10" name=""/>
    <alias field="img_year" index="11" name=""/>
    <alias field="height" index="12" name=""/>
    <alias field="sector" index="13" name=""/>
    <alias field="crops" index="14" name=""/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="reap_month"/>
    ...
    <policy policy="Duplicate" field="area_sq_m"/>
    <policy policy="Duplicate" field="sow_month"/>
    <policy policy="Duplicate" field="unique_id"/>
    <policy policy="Duplicate" field="img_year"/>
    <policy policy="Duplicate" field="height"/>
    <policy policy="Duplicate" field="sector"/>
    <policy policy="Duplicate" field="crops"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="reap_month" expression=""/>
    ...
    <default applyOnUpdate="0" field="sow_month" expression=""/>
    ...
    <default applyOnUpdate="0" field="sector" expression=""/>
    <default applyOnUpdate="0" field="crops" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" field="reap_month" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="area_sq_m" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="sow_month" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="sector" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="crops" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="reap_month"/>
    ...
    <constraint exp="" desc="" field="area_sq_m"/>
    <constraint exp="" desc="" field="sow_month"/>
    ...
    <constraint exp="" desc="" field="crops"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" hidden="0" name="reap_month" width="-1"/>
      ...
      <column type="field" hidden="0" name="sow_month" width="-1"/>
      ...
      <column type="field" hidden="0" name="crops" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="area_sq_m"/>
    <field reuseLastValue="0" name="crops"/>
