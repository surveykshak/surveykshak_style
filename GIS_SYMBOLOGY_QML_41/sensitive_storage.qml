...
<qgis minScale="100000000" version="3.38.2-Grenoble" simplifyAlgorithm="0" simplifyDrawingHints="0" maxScale="0" symbologyReferenceScale="-1" readOnly="0" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" simplifyMaxScale="1" simplifyLocal="1">
  <flags>
  ...
  <temporal durationUnit="min" limitMode="0" fixedDuration="0" startExpression="" durationField="gid" enabled="0" mode="0" startField="updated_on" endField="" endExpression="" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation type="IndividualFeatures" symbology="Line" zscale="1" extrusionEnabled="0" showMarkerSymbolInSurfacePlots="0" extrusion="0" clamping="Terrain" binding="Centroid" respectLayerSymbol="1" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleLine" id="{e3c5b535-6c32-479a-ad22-91637ecbd4de}" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol force_rhr="0" type="fill" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleFill" id="{38d29b0b-a7c5-43d1-991c-90fece913452}" locked="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" id="{0e3b0d18-e319-46b5-a2ee-1cf858e7c6f5}" locked="0">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" type="singleSymbol" referencescale="-1" forceraster="0">
    <symbols>
      <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="0">
        ...
        <layer enabled="1" pass="0" class="SvgMarker" id="{80c3419d-5daf-43c6-a5f1-d388bb1c4257}" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="157,144,137,255,hsv:0.06111111111111111,0.12941176470588237,0.61568627450980395,1" name="color"/>
            <Option type="QString" value="0" name="fixedAspectRatio"/>
            <Option type="QString" value="1" name="horizontal_anchor_point"/>
            <Option type="QString" value="base64:" name="name"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol force_rhr="0" type="marker" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
        ...
        <layer enabled="1" pass="0" class="SimpleMarker" id="{28d2c04e-08b5-4739-ab1c-7cd94bbe7440}" locked="0">
          <Option type="Map">
            <Option type="QString" value="0" name="angle"/>
            <Option type="QString" value="square" name="cap_style"/>
    ...
    <DiagramCategory opacity="1" spacing="5" backgroundAlpha="255" showAxis="1" scaleBasedVisibility="0" rotationOffset="270" lineSizeScale="3x:0,0,0,0,0,0" sizeType="MM" spacingUnit="MM" barWidth="5" minimumSize="0" penWidth="0" direction="0" lineSizeType="MM" maxScaleDenominator="1e+08" width="15" backgroundColor="#ffffff" penAlpha="255" enabled="0" sizeScale="3x:0,0,0,0,0,0" height="15" penColor="#000000" scaleDependency="Area" minScaleDenominator="0" spacingUnitScale="3x:0,0,0,0,0,0" diagramOrientation="Up" labelPlacementMethod="XHeight">
      ...
      <axisSymbol>
        <symbol force_rhr="0" type="line" alpha="1" clip_to_extent="1" is_animated="0" frame_rate="10" name="">
          ...
          <layer enabled="1" pass="0" class="SimpleLine" id="{3f5ed758-b375-42bf-8511-87bff0f82bc6}" locked="0">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="dist_fr_ib">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
        ...
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="Satellite Image" name="Satellite Image"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="Open Source" name="Open Source"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="AAS Data" name="AAS Data"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="MI Data" name="MI Data"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="longitude">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="gen_area">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="latitude">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="aas_id">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
      ...
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="Ammunition depot" name="Ammunition depot"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="Ammunition dump" name="Ammunition dump"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="Coal depot" name="Coal depot"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="Coal dump" name="Coal dump"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="FOL depot" name="FOL depot"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="FOL dump" name="FOL dump"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="Gas depot" name="Gas depot"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="Gas dump" name="Gas dump"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="gr">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="dist_fr_ib" index="1" name=""/>
    ...
    <alias field="longitude" index="7" name=""/>
    <alias field="unique_id" index="8" name=""/>
    <alias field="gen_area" index="9" name=""/>
    <alias field="img_year" index="10" name=""/>
    <alias field="latitude" index="11" name=""/>
    ...
    <alias field="gr" index="17" name=""/>
  </aliases>
  <splitPolicies>
    <policy policy="Duplicate" field="gid"/>
    <policy policy="Duplicate" field="dist_fr_ib"/>
    ...
    <policy policy="Duplicate" field="gr"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="gid"/>
    <policy policy="Duplicate" field="dist_fr_ib"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="dist_fr_ib" expression=""/>
  ...
  <constraints>
    ...
    <constraint constraints="0" unique_strength="0" field="dist_fr_ib" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="longitude" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="unique_id" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="gen_area" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="img_year" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="latitude" exp_strength="0" notnull_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="aas_id" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="gr" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="gid"/>
    <constraint exp="" desc="" field="dist_fr_ib"/>
    ...
    <constraint exp="" desc="" field="gen_area"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column type="field" hidden="0" name="dist_fr_ib" width="-1"/>
      ...
      <column type="field" hidden="0" name="gr" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="dist_fr_ib"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="dist_fr_ib"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="dist_fr_ib"/>
    <field reuseLastValue="0" name="gen_area"/>
